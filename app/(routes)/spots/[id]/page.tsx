...
export default async function SpotDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white font-sans pb-24 overflow-y-auto [&::-webkit-scrollbar]:hidden">
      ...
      <div className="relative h-72 w-full bg-gradient-to-b from-indigo-200 dark:from-blue-900 to-zinc-50 dark:to-zinc-950 flex flex-col justify-end p-4">
        ...
        <p className="text-zinc-600 dark:text-gray-300 text-sm flex items-center gap-1">
