...
export default async function PlaceListDetailPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white font-sans pb-24">
      ...
      <header className="sticky top-0 z-50 flex items-center px-4 pt-10 pb-4 bg-zinc-50/95 dark:bg-zinc-950/95 backdrop-blur-sm border-b border-zinc-200 dark:border-zinc-800">
        ...
        {isOwner && (
          ...
          >
            <Pencil className="w-5 h-5 text-zinc-700 dark:text-white" />
          </Link>
        )}
      </header>
