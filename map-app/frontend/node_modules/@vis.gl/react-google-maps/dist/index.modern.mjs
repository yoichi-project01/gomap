import React, { useMemo, useState, useReducer, useCallback, useEffect, useRef, useContext, useLayoutEffect, useInsertionEffect, forwardRef, useImperativeHandle, Children, createContext } from 'react';
...
const useBeforeEffect = useInsertionEffect !== null && useInsertionEffect !== void 0 ? useInsertionEffect : useLayoutEffect;
